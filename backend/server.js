...
app.post('/api/users' , async (req,res) => {
    try{
        ...
        const result = await db.request()
            ...
            .input('Creditcard' , sql.VarChar(19), Creditcard)
            .query('INSERT INTO users (Firstname,Lastname,Phone,Creditcard) VALUES (@Firstname,@Lastname,@Phone,@Creditcard); SELECT SCOPE_IDENTITY() AS id')
